...
const router = createRouter({
    history:createWebHashHistory(import.meta.env.BASE_URL), //设置为history模式，就是路径里面没有#，createWebHashHistory是默认的，括号里面就是基础路径，可以理解为项目名称，就是请求路径的基础url
    routes
})
